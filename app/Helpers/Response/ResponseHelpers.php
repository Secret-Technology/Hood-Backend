...
trait ResponseHelpers
{
     ...
     */
    protected function respondOk($data = null, $message = null)
    {
    ...
    {
        return $this->respondError($message, Response::HTTP_UNPROCESSABLE_ENTITY);
    }
    ...
    protected function formatResponseData($data, $message = null)
    {
        ...
        return array_filter(array_merge(compact('status', 'message'), $data), function ($value) {
