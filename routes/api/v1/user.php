...
Route::middleware('current_locale')->group(function () {
     ...
     */
    Route::namespace('Rate')->middleware('auth:user')->group(function () {
     ...
     * Start Rate EndPoints
     */
    Route::namespace('WalletTransaction')->middleware('auth:user')->group(function () {
        Route::get('wallet_transactions', 'WalletTransactionController@index');
        Route::get('all_transactions', 'WalletTransactionController@allTransactions');
        Route::post('charge', 'WalletTransactionController@charge');
    });
    /**
     * End Rate EndPoints
     */
